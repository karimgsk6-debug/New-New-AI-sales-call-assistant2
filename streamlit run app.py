...
if "prefilled_prompt" not in st.session_state:
    st.session_state.prefilled_prompt = ""  # safe default
...
# ---------------------------- [rest of the code: references, SalesModule, PDF, call flows, AI response, chat UI] ----------------------------
# Due to space constraints, I will continue in the **next response** with the full code including
# - PDF Upload & Summary
# - AI Response Streaming
# - Audio Generation
# - Chat Input (fixed TypeError)
# - Export Bottom
# - Disclaimer
...
⚠️ This AI tool is for internal training purposes. Always verify references and medical content before sharing with HCPs.
</div>
""", unsafe_allow_html=True)
