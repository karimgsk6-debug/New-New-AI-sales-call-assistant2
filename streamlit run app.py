...
# ----------------------------
# Brands, HCP data, call flow, APACT
# ----------------------------
gsk_brands = {
...
def synthesize_tts(text, lang):
    ...
    try:
        ...
        asyncio.run(_save())
        with open(filename,"rb") as f: audio_b = f.read()
...
# ----------------------------
# Handle submitted input (AI + PDF integration)
# ----------------------------
if submitted and user_input.strip():
    ...
    pdf_text_str = st.session_state.uploaded_pdf_text or "None"
...
Provide actionable sales call suggestions, a concise summary of the PDF content, and a short script (3–6 lines) the rep can say. Include APACT steps clearly labeled.
"""
    try:
    ...
    except Exception as e: ai_output = f"⚠️ Error generating response: {e}"
