...
def ask_ai(prompt):
    try:
        response = client.chat.completions.create(
            ...
            messages=[
                {"role": "system", "content": "You are a helpful AI medical sales assistant. Structure responses according to the pharma sales call flow and APACT technique. Always reference uploaded medical/product docs if available."},
...
➡️ Please provide a structured response following this flow:
1. Prepare the Call
2. Engage
